...
<head>
    ...
    <!-- Bootstrap 3.3.6 -->
    <link rel="preload" href="<?= $this->versionControl( TEMPLATE . "bower_components/bootstrap/dist/css/bootstrap.min.css" ) ?>"  as="style" onload="this.rel='stylesheet'">
    <!-- Theme style -->
    <link rel="preload" href="<?= $this->versionControl( TEMPLATE ."dist/css/AdminLTE.min.css" ) ?>"  as="style" onload="this.rel='stylesheet'">
    ...
    <!-- js markdown -->
    <link rel="preload" href="<?= $this->versionControl( COMPOSER . "bower-asset/highlight-js/src/styles/default.css")?>" as="style" onload="this.rel='stylesheet'">
    <script>
        var AdminLTEOptions = {
...
<div class="wrapper" style="height: auto; min-height: 100%;">
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="btn-group">
                <a href="#" class="btn btn-primary navbar-btn dropdown-toggle bg-gray" data-toggle="dropdown">
            ...
            <ul class="sidebar-menu tree" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li>
                            <a href="<?=SITE?>Htaccess"><i class="fa fa-file-code-o"></i>.htaccess</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="OSSupport"><i class="fa fa-chrome"></i><span>OS Support</span></a>
                </li>
                <li>
                    <a href="UpgradeGuide"><i class="fa fa-hand-o-up"></i><span>Upgrade Guide</span></a>
                </li>
                <li>
...
<script>
    ...
    loadJS("<?= $this->versionControl( TEMPLATE . 'bower_components/jquery/dist/jquery.min.js' ) ?>", function () {
        ...
        loadJS("<?= $this->versionControl( TEMPLATE . 'bower_components/bootstrap/dist/js/bootstrap.min.js' ) ?>", function () {
            ...
            //-- Js Markdown -->
            loadJS("<?= $this->versionControl( COMPOSER . 'bower-asset/highlight-js/src/highlight.js' )?>", function () {
            ...
            loadJS("<?= $this->versionControl(  COMPOSER .'bower-asset/jquery-pjax/jquery.pjax.js' ) ?>", function () {
                loadJS("<?= $this->versionControl( COMPOSER .'bower-asset/mustache.js/mustache.js' ) ?>", function () {
                    ...
                    $(document).on('pjax:complete', function () {
                        $('article').fadeIn('fast').removeClass('overlay');
                    });
