                        ...
                        <div class="box box-info" id="ProfileSettings">
                            ...
                            <form data-pjax class="form-horizontal" action="<?= SITE ?>Profile/" method="post"
                                ...
                                <div class="box-footer">
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal">Delete Account</button>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Please confirm your account deletion</h4>
                                            </div>
                                            <div class="modal-body">
                                                Your account will no longer be visible or accessible. Please ensure you export
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="<?=site?>Profile/DeleteAccount/" type="button" class="btn btn-danger">Delete Account</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
